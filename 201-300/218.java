...
/*
This solution to this problem is to split a building to a starting point and an ending point, with height. 
To distinguish, starting point with positive heights, ending point with negative heights, then sort them. 
Iterate these points, use a priorityqueue to store current heights, higher height has higher priority. 
If a building starts, add the height to pq, if a building ends, remove the height from pq, 
if current highest height changes, add {current point, current highest height} to result.
*/
class Solution {
